...
export const IDLE_WORLD_TIMEOUT = 60 * 60 * 1000; // 1 hour
...
export { MAX_HUMAN_PLAYERS } from '../src/shared/constants';
...
export const PLAYER_CONVERSATION_COOLDOWN = 180_000;
...
export const INVITE_TIMEOUT = 90_000;

// Wait for another player to say something before jumping in.
export const AWKWARD_CONVERSATION_TIMEOUT = 45_000; // shorter to keep replies brief
// export const AWKWARD_CONVERSATION_TIMEOUT = 20_000;

// Leave a conversation after participating too long.
export const MAX_CONVERSATION_DURATION = 5 * 60_000; // end chats sooner by default
...
export const HUMAN_IDLE_TOO_LONG = 15 * 60 * 1000;
...
export const ACTIVITIES = [
  ...
  { description: 'reading the news', emoji: '📰', duration: 60_000 },
];
